...
var vk = {
  ...
  contlen: 7784,
  loginscheme: 'https',
  ip_h: 'b141dfef0493fa476e',
  vc_h: 'e19c472913d583d2c5f120911780e9e4',
  navPrefix: '/',
  dt: parseInt('0') || 0,
  fs: parseInt('11') || 11,
  ts: 1408730257,
...
var StaticFiles = {
  ...
  'ie6.css'   : {v: 26},
  'ie7.css'   : {v: 18}
  ,'lang0_0.js':{v:6570},'index.css':{v:26},'index.js':{v:32}
}
</script>

<link rel="stylesheet" type="text/css" href="http://st0.vk.me/css/al/common.css?464">
...
<div><div class="scroll_fix" style="width: 940px;">
  ...
  <div id="top_links">
    <div class="fl_r" id="top_menu_wrap" style="">
      ...
      <a id="top_switch_lang" class="fl_r top_nav_link" style="" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 3, hash: '9f9c5848839aab76d7'});" onmousedown="tnActive(this)">Switch to English</a>
    </div>
    <a class="fl_l top_nav_link" href="" id="top_back_link" onclick="return nav.go(this, event, {back: true})" onmousedown="tnActive(this)" style="max-width: 748px;"></a>
  </div>
</div>
      </div>
    </div>
    ...
    <div id="side_bar" class="fl_l" style="">
      <div id="quick_login">
  <div><iframe class="upload_frame" id="quick_login_frame" name="quick_login_frame"></iframe></div><form method="POST" name="login" id="quick_login_form" action="/">
    ...
    <input type="hidden" name="ip_h" value="b141dfef0493fa476e">
  ...
  <iframe class="upload_frame" src="https://login.vk.com/?role=al_frame&amp;_origin=http://vk.com&amp;ip_h=b141dfef0493fa476e"></iframe>
  <div class="content">
    ...
    <div class="ij_form">
      <div class="ij_reg_row">
        <div class="input_back_wrap no_select"><div class="input_back" style="margin: 1px; padding: 5px 4px 4px;"><div class="input_back_content" style="width: 140px;">Ваше имя</div></div></div><input type="text" class="big_text" id="ij_first_name" value="" onkeydown="if (event.keyCode == 10 || event.keyCode == 13) Index.submitJoinStart();">
      </div>
      <div class="ij_reg_row">
        <div class="input_back_wrap no_select"><div class="input_back" style="margin: 1px; padding: 5px 4px 4px;"><div class="input_back_content" style="width: 140px;">Ваша фамилия</div></div></div><input type="text" class="big_text" id="ij_last_name" value="" onkeydown="if (event.keyCode == 10 || event.keyCode == 13) Index.submitJoinStart();">
      </div>
      ...
      <div id="index_fbsign">
        <div class="index_fbb">
          ...
          <div class="button_blue button_wide button_big ij_button index_fb_btn">
            <button id="index_fb" onclick="Index.fbJoin();">
  ...
  <div class="reg">
    <table cellspacing="0" cellpadding="0" id="ij_screens"><tbody><tr>
      <td><a class="ij_scr" onclick="JoinPhotoview.show(0)"><img src="http://vk.com/images/join/prof_m.png?4" class="ijs_img"></a></td>
      <td><a class="ij_scr" onclick="JoinPhotoview.show(1)"><img src="http://vk.com/images/join/news_m.png?4" class="ijs_img"></a></td>
      <td><a class="ij_scr" onclick="JoinPhotoview.show(2)"><img src="http://vk.com/images/join/dial_m.png?4" class="ijs_img"></a></td>
    </tr></tbody></table>
  </div>
</div></div>
  </div>
...
<div id="footer" class="clear">
  <div class="copy_lang"><a href="/about">ВКонтакте</a> © 2014 <a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 3, hash: '9f9c5848839aab76d7'})">English</a><a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 0, hash: '9f9c5848839aab76d7'})">Русский</a><a class="bnav_lang" onclick="ajax.post('al_index.php', {act: 'change_lang', lang_id: 1, hash: '9f9c5848839aab76d7'})">Українська</a><a class="bnav_lang" onclick="if (vk.al) { showBox('lang.php', {act: 'lang_dialog', all: 1}, {params: {dark: true, bodyStyle: 'padding: 0px'}, noreload: true}); } else { changeLang(1); } return false;">все языки »</a></div>
...
JoinPhotoview.init([{"src":"\/images\/join\/prof_1.png?5","width":790,"height":600,"desc":"Делитесь с друзьями фотографиями и новостями"},{"src":"\/images\/join\/news_1.png?5","width":790,"height":600,"desc":"Получайте новости из жизни Ваших друзей и известных людей"},{"src":"\/images\/join\/dial_1.png?5","width":790,"height":600,"desc":"Общайтесь с близкими при помощи личных сообщений"}]);
